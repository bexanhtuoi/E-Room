...
from app.api.routers import auth, document, google_auth, message, notification, room, session, user
...
api_router.include_router(session, prefix="/sessions", tags=["sessions"])
