...
DEFAULT_TAGS: list[TagSeed] = [
    ...
    {"name": "Prompt Engineering", "slug": "prompt-engineering", "category": "technology", "icon": "💬"},
    {"name": "LLM", "slug": "llm", "category": "technology", "icon": "🧠"},
    {"name": "Machine Learning", "slug": "machine-learning", "category": "technology", "icon": "📈"},
    {"name": "AI Ethics", "slug": "ai-ethics", "category": "technology", "icon": "⚖️"},
    {"name": "AI Tools", "slug": "ai-tools", "category": "technology", "icon": "🛠️"},
    {"name": "Computer Vision", "slug": "computer-vision", "category": "technology", "icon": "👁️"},
    {"name": "NLP", "slug": "nlp", "category": "technology", "icon": "📝"},
]
