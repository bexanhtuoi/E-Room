...
function getPasswordStrength(pw) {
  ...
  const map = [
    ...
    { score: 3, label: 'Good', color: '#ffffff' },
    { score: 4, label: 'Strong', color: '#ffffff' },
    { score: 5, label: 'Great', color: '#ffffff' },
  ];
...
export function LoginPage() {
  ...
  const brandFeatures = [
    { icon: HiGlobeAlt, text: t('auth.feature_1', 'Practice English in live video rooms with real people worldwide') },
    { icon: HiLightBulb, text: t('auth.feature_2', 'AI-powered real-time feedback on pronunciation & grammar') },
    { icon: HiShieldCheck, text: t('auth.feature_3', 'Safe, moderated environment with NSFW protection') },
    { icon: HiSparkles, text: t('auth.feature_4', 'Smart matching pairs you with learners at your level') },
  ];
            ...
            <div style={{ maxWidth: 440, width: '100%' }} className="fade-in-up">
              ...
              <div className="mb-4">
                <h2 className="fw-extrabold mb-1" style={{ fontFamily: 'Nunito, sans-serif', color: 'var(--color-text-primary)', fontSize: '1.7rem' }}>
                  {isRegister ? t('auth.create_account_title') : t('auth.welcome_back')}
                </h2>
              ...
              <div className="d-flex align-items-center gap-3 mb-4">
                ...
                <small style={{ color: 'var(--color-text-muted)', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.1em' }}>{t('auth.or')}</small>
                <div className="flex-grow-1" style={{ height: 1, background: 'var(--color-border)' }} />
              </div>
